...
#ifndef AAMYTRIPS_SWIFT_H
#define AAMYTRIPS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AAMyTrips",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9AAMyTrips19TripShareItemSource")
@interface TripShareItemSource : NSObject <UIActivityItemSource>
